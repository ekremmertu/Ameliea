        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:amelieadestek@gmail.com" className="text-rose-600 hover:text-rose-700">
                amelieadestek@gmail.com
              </a>
            </div>
            <div className="flex items-center gap-3">
              <svg className="w-5 h-5 text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://instagram.com/Ameliea.co" target="_blank" rel="noopener noreferrer" className="text-rose-600 hover:text-rose-700">
                @Ameliea.co
              </a>
            </div>
          </div>
